...
SECRET_KEY = "django-insecure-^wk8j2p13&het^x@cyd9@qy@wxe07r5pxw30xi0_g!^cye!2ev"
...
INSTALLED_APPS = [
    "main", #rejister main app
    "corsheaders", #for cross origin(fetch data from react to django)
    "rest_framework",
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": (
        "rest_framework.permissions.AllowAny", #we have to add credentials replace AllowAny to IsAuthenticated
    ),
}
